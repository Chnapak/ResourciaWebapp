...
namespace Resourcia.Data.Migrations
{
    ...
    [Migration("20260428130540_AddBetaInvites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resourcia.Data.Entities.BetaInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Resourcia.Data.Entities.ResourceAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("RevertedAuditId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ResourceId", "CreatedAtUtc");

                    b.ToTable("ResourceAuditEntries");
                });
            ...
            modelBuilder.Entity("Resourcia.Data.Entities.ReviewVotes", b =>
                {
                    ...
                    b.Property<Guid?>("ResourceReviewId")
                        .HasColumnType("uuid");

                    b.HasKey("ReviewId", "UserId");

                    b.HasIndex("ResourceReviewId");
            ...
            modelBuilder.Entity("Resourcia.Data.Entities.ReviewVotes", b =>
                {
                    b.HasOne("Resourcia.Data.Entities.ResourceReview", null)
                        .WithMany("Votes")
